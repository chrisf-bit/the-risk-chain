...
- **C · Emergency, survived** *(mirrors the proven-safe S1 C; re-record)* > This one was a close call, and the worst was avoided. But it came far closer than it ever should have. By the time things reached that point, the safe controls earlier in the shift had already gone. The screen below shows the chain that led there, and where any single link, held, would have changed it. Sit with it for a moment, because a shift should never get this close.
...
- **C · Emergency, survived** *(mirrors the proven-safe S1 C; re-record)* > This one was a close call, and the worst was avoided. But it came far closer than it ever should have, made more likely by the rush and the disrupted room around you. By the time things reached that point, the safe margins earlier in the shift had already gone. The screen below shows the chain that led there, and where any single link, held, would have changed it. Sit with it for a moment, because a shift should never get this close.
...
- **C · Emergency, survived** *(mirrors the proven-safe S1 C; re-record)* > This one was a close call, and the worst was avoided. But it came far closer than it ever should have, in a busy public place with the family around you. By the time things reached that point, the safe controls earlier in the shift had already gone under the pressure. The screen below shows the chain that led there, and where any single link, held, would have changed it. Sit with it for a moment, because a shift should never get this close.
